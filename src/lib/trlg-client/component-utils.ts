...
function _getRanks(p0: number, p1: number, p2: number, p3: number): [RankType, RankType, RankType, RankType] {
    ...
    const preSorted: [Aug, Aug, Aug, Aug] = [...preAugmented.sort(([_a,a],[_b,b]) => b-a)] as [Aug, Aug, Aug, Aug]
    ...
    const postSorted: [[0|1|2|3, RankType], [0|1|2|3, RankType], [0|1|2|3, RankType], [0|1|2|3, RankType]] = cleanup.sort(([a, _a], [b, _b]) => a-b) as [[0|1|2|3, RankType], [0|1|2|3, RankType], [0|1|2|3, RankType], [0|1|2|3, RankType]]
